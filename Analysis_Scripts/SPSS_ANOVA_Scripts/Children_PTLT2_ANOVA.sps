...
GET DATA
  /TYPE=TXT
  /FILE="C:\Users\ksteinfe\Desktop\MCPP_Scripts\children\2_analysis\dwell\PTLT2_Wide_CondStimType.csv"
  /DELCASE=LINE
  /DELIMITERS=","
  /QUALIFIER='"'
...
GLM Async_distractors Async_target Sync_distractors Sync_target BY Age

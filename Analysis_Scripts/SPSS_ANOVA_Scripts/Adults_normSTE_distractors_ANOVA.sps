...
GET DATA
  /TYPE=TXT
  /FILE="C:\Users\ksteinfe\Desktop\MCPP_Scripts\adults\2_analysis\dwell\normSTE_distractors_Wide_CondTarg.csv"
  /DELCASE=LINE
  /DELIMITERS=","
  /QUALIFIER='"'
...
DATASET NAME normSTE_distractors_Wide_CondTarg.
